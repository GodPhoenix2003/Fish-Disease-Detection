...
cnn = tf.keras.models.load_model('C:/Coding/Sem 6 Project/fish_disease_detection_model.keras', compile=False)
...
path = 'C:/Coding/Sem 6 Project/Test_Images'
...
def get_disease_info(disease_name):
    disease = []
    trt = 'C:/Coding/Sem 6 Project/Treatment.csv'
